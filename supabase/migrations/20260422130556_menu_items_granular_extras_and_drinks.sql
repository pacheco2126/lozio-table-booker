-- Add slug column to match frontend extra IDs for server-side price validation
ALTER TABLE menu_items ADD COLUMN IF NOT EXISTS slug text UNIQUE;

-- ─── Remove generic extras and generic refresco ───────────────────────────────
DELETE FROM menu_items WHERE id IN (
  '6addf355-47e9-40e2-919a-a3144a99b54f', -- Extra: Verdura
  '9b863756-4392-4169-9b24-da18fb784da9', -- Extra: Embutido / Queso
  '779cd0d0-55da-4858-9534-4d8b7b224d99', -- Extra: Mozzarella búfala
  '0b488ca4-0ff6-4ac5-b6ab-b18c64225afc'  -- Refresco (genérico)
);

-- ─── Assign slugs to existing items ──────────────────────────────────────────
...
-- ─── Specific sodas ───────────────────────────────────────────────────────────
INSERT INTO menu_items (name, price, category, allergens, is_active, sort_order, slug) VALUES
