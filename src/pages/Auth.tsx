      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-card rounded-lg p-8 shadow-lg border border-border">
          <button
            ...
            className="w-full flex items-center justify-center gap-3 bg-background border border-input text-foreground py-3 min-h-[48px] rounded-sm font-body font-medium text-sm hover:bg-muted transition-colors disabled:opacity-50 mb-3"
          >
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 bg-foreground text-background py-3 min-h-[48px] rounded-sm font-body font-medium text-sm hover:opacity-90 transition-opacity disabled:opacity-50 mb-6"
          >
